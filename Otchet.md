...
## 3. Далее после 6 безуспешных попыток, исправив все ошибки, инициировал сборку, сборка прошла успешно, после проверил результат, открыв приложение в браузере
## 4. Далее сделал изменение в html файле и совершил коммит, чтобы проверить все ли работает, и да, все работает
![Image1](i2.jpg)
